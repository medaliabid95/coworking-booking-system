      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative animate-fadeIn">
            ...
            <div className="absolute -bottom-8 -right-8 w-48 h-48 bg-purple-600 rounded-lg opacity-20"></div>
          </div>

          {/* Content */}
          <div className="space-y-6">
            <p className="text-purple-600 animate-fadeIn">About Us</p>
              ...
              <div className="animate-fadeIn" style={{ animationDelay: '0.5s' }}>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    <Circle className="w-2 h-2 text-purple-600 mt-2 flex-shrink-0" fill="currentColor" />
