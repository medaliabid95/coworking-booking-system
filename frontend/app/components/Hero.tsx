      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-white space-y-6">
            <p className="text-purple-300 tracking-wide animate-fadeIn">Welcome to Varspace</p>
            ...
            <div className="flex flex-wrap gap-4 animate-fadeIn" style={{ animationDelay: '0.6s' }}>
              ...
              <button className="border-2 border-white text-white px-8 py-3 rounded hover:bg-white/10 transition">
                Get a Tour
              </button>
            </div>
          </div>
